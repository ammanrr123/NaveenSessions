...
public class ActCommentary {
	...
	public static void main(String[] args) throws Exception {
		...
		ExcelDataConfig excel=new ExcelDataConfig("\\USHOUHOME01\\kolace\\Desktop\\New folder\\UploadCommentary2p.xlsx");
		//ExcelDataConfig excel=new ExcelDataConfig("C:\\Users\\ammanrr.CORP\\eclipse-workspace\\UploadCommentary1.xlsx");
		
		driver.get(excel.getData(1,1,0));
		
		driver.findElement(By.xpath("//*[@id='userid']")).sendKeys(excel.getData(1, 1, 1));
		
		driver.findElement(By.xpath("//*[@id='password']")).sendKeys(excel.getData(1, 1, 2));
		...
		if(text.equalsIgnoreCase(excel.getData(3, 1, 0))) {
			...
			if(text5.equalsIgnoreCase(excel.getData(3, 1, 4)))
			{
				e1.click();
			...
			e4.clear();
			e4.sendKeys(excel.getData(0, row, 1));
          ...
          // driver.findElement(By.xpath("//*[@id='CompDataWordML']")).sendKeys(excel.getData(0, row, 2));
           
            driver.findElement(By.xpath("//*[@id='CompDataWordML']")).sendKeys(excel.getData(0, 1, 3));
            ...
            System.out.println(excel.getData(0, row, 0)+"successfully upload the commentary file");
            WebElement e6=driver.findElement(By.xpath("//input[@value='Reset']"));
            
            e6.click();
            Thread.sleep(2000);
            
            //Utility.setExcelFile("C:\\Users\\ammanrr.CORP\\eclipse-workspace\\UploadCommentary1.xlsx","Sheet1");
